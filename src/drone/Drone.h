...
public:
	...
	/**
	 * Send a command to control the drone with the same api as with a joystick.
	 */
	int manual_control(DroneManualCommand manualCommand);
